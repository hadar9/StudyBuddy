...
import { choosegroup, selectrecipient, setcurrentgroupid} from '../../../actions/chat';
...
export default connect(mapStateToProps, {choosegroup, selectrecipient, setcurrentgroupid})(sidebarChat);
